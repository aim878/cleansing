...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>backend/gritter/css/jquery.gritter.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>backend/uniform/css/uniform.default.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>backend/bootstrap-daterangepicker/daterangepicker.css" />
	<link href="<?php echo base_url(); ?>backend/fullcalendar/fullcalendar/bootstrap-fullcalendar.css" rel="stylesheet" />
	<link href="<?php echo base_url(); ?>backend/jqvmap/jqvmap/jqvmap.css" media="screen" rel="stylesheet" type="text/css" />
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>backend/bootstrap-wysihtml5/bootstrap-wysihtml5.css" />
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown" id="header_inbox_bar">
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								<a href="#">
								<span class="photo"><img src="<?php echo base_url(); ?>backend/img/avatar2.jpg" alt="" /></span>
								<span class="subject">
							...
							<li>
								<a href="#">
								<span class="photo"><img src="<?php echo base_url(); ?>backend/img/avatar3.jpg" alt="" /></span>
								<span class="subject">
							...
							<li>
								<a href="#">
								<span class="photo"><img src="<?php echo base_url(); ?>backend/img/avatar1.jpg" alt="" /></span>
								<span class="subject">
