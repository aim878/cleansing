				...
				<div id="dashboard">
					<div class="row-fluid">
						...
						<div class="portlet box blue">
		                     <div class="portlet-title">
		                        <h4><i class="icon-reorder"></i>Services Insert</h4>
		                        <div class="tools">
							...
							<div class="portlet-body form">	
								<form class="form-horizontal" action="<?php echo base_url(); ?>post_services_data" method="post" enctype="multipart/form-data">
